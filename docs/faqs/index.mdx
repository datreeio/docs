...
Yes. Datree also has a [Helm plugin](https://github.com/datreeio/helm-datree) that can be accessed through the helm CLI, to provide a seamless experience to Helm users.
