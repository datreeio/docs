...
:::caution Note
After installation, Datree runs with enforcement mode **disabled** by default. To enable enforcement mode, see the [behavior](/setup/behavior) page.
:::
...
```
**Note that you need to have [jq](https://stedolan.github.io/jq/) installed to run this command.**
