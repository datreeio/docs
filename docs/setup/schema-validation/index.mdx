...
The [CRDs-catalog repository](https://github.com/datreeio/CRDs-catalog#crd-extractor) also contains a small and simple utility (currently supported only on Linux & MacOS).
