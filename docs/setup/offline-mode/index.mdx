...
:::info
Note that '{{ .ResourceKind }}{{ .KindSuffix }}.json' does not to be replaced with an actual filename, the CLI will be able to access all .json files with this name format in the specified directory.
:::