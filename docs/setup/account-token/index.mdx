...
<img src='/img/setup/account-token/1.png' alt=''/>
...
Setting your token in your CI is done using an environment variable. The Datree CLI automatically checks this variable and uses its value as the token.  
