...
- [Evaluated files](https://hub.datree.io/cli-output#u6-evaluated-files)

- [Check body](https://hub.datree.io/cli-output#p0-check-body)
...
- [Check summary](https://hub.datree.io/cli-output#4q-check-summary)
...
- **Enabled rules in policy “default”** - number of rules enabled on this [policy](https://hub.datree.io/faq#f-what-is-a-policy)
...
- **See all rules in policy** - link to your account [Centralized policy](docId:0-uWz2hrYE6OvSK15gWNK) dashboard
