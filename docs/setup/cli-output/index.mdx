...
If one of the validations (YAML and Kubernetes schema) OR the policy check fails - the CLI will return **exit code 1**, else (all validations and policy check passed) - it will return **exit code 0**.
