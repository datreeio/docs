...
* [Worng Kubernetes schema version](troubleshooting#worng-kubernetes-schema-version) - you need to update the schema version on your dashboard
...
```  
Your Datree's schema validation version can be found on your dashboard (under _SETTINGS_) or in your policy check summary:  
```terminal
(Summary)
