...
1.  [Get your dashboard account token](/setup/account-token#from-the-centralized-policy-dashboard)

2.  [Set your dashboard account token in your CLI](/setup/account-token#overriding-account-token)
