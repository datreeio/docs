...
On the bottom of the page, you can see 2 lists of rules - one for the rules that failed in the last scan, and the other for rules that passed. Clicking on a failed rule will take you to the [drilldown](/dashboard/drilldown) page, where you can see more information about the rule and its violations in your cluster.

![failing_rules](/img/dashboard/overview/failing-rules.png)