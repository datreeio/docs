...
Inviting team members to collaborate is available as part of certain payment plans. Plan details can be found on our [pricing page](https://www.datree.io/pricing)
:::
...
- Click on the "USER MANAGEMENT" tab, then click "Invite User"
![settings](/img/dashboard/user-management/invite-user.png)
...
![settings](/img/dashboard/user-management/edit-user.png)
3. Click on "Edit"
