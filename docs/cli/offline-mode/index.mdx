...
3. [Enable](https://hub.datree.io/dashboard/policy-as-code#1-enable-policy-as-code-pac-mode) the policy-as-code mode for your account
4. Set `offline=local` in your local [config file](/cli/cli-arguments/#configure-the-cli):  
```terminal
