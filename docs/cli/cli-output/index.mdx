...
- [Evaluated files](/cli/cli-output#evaluated-files)

- [Check body](/cli/cli-output#check-body)
...
- [Check summary](/cli/cli-output#check-summary)

  - Files status

  - Policy table

![terminal_output](/img/cli/cli-output/1.png)
...
![terminal_output_explained](/img/cli/cli-output/2.png)
...
- **See all rules in policy** - link to your account [Centralized policy](/dashboard/centralized-policy) dashboard
