---
title: Downgrade to community version
slug: /guides/downgrade-to-community
---
...
## Downgrade to community version
...
If you don't want to keep your dashboard synced, you can stop reporting policy check results by using the `--no-record` argument.
...
No, you will not be blocked in any way from using the CLI in your CI.
