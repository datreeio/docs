---
title: ☑️ Prevent exposed secrets in Vault objects
...
If a Vault **batch token and/or service token** are present anywhere in the manifest:
...
❌ Prevent exposed secrets in Vault objects [1 occurrence]
