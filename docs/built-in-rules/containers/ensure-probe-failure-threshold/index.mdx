---
title: ☑️ Ensure container probes have a configured failure threshold
...
❌ Ensure container probes have a configured failure threshold [1 occurrence]
💡 Incorrect value for key `failureThreshold` - set to prevent unwanted default failure threshold behavior
```
