...
ArgoCD is installed in a specific namespace (by default 'argocd'). All of its resources, including Application and AppProject instances, have to be installed in that namespace.
...
- [**_Block87 - Argo CD Namespace Isolation_**](https://blog.andyserver.com/2020/12/argocd-namespace-isolation/)
