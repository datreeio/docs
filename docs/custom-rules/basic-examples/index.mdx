...
The following schema defines a blacklist of values for the key `das`:
...
Enable PaC mode and publish the policies.yaml configuration ([read more](/custom-rules/policy-as-code#how-does-it-work))
:::
