...
1.  [Ensure correct environment labels are used](https://hub.datree.io/basic-examples#c6-example-1)

2.  [Prevent workload from using the (system) default namespaces](https://hub.datree.io/basic-examples#t0-example-2)

3.  [Ensure Deployment has replicas set between 2-10](https://hub.datree.io/basic-examples#h3-example-3)
