...
- **Active policy** - The name of the policy to check, e.g: "Argo". See *policy* parameter in the options table below.
- **Ignored resources** - Resources to be ignored, specified by namespace/kind/name or any combination of the three. See [*custom skipping*](/configuration/behavior#custom-skipping) section below.
