...
- **Action on failure** - Select whether to monitor or block resources that fail the policy check. See *enforce* parameter in the options table below.
- **Active policy** - The name of the policy to check, e.g: "CIS". See *policy* parameter in the options table below.
- **Ignored resources** - Resources to be ignored, specified by namespace/kind/name or any combination of the three. See *customSkipList* parameter in the options table below.
