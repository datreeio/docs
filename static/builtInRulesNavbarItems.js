...
export const navItems = [
  ...
  {
    id: uuid(),
    title: "Ensure container probes have an initial delay configured",
  ...
  {
    id: uuid(),
    title: "Ensure container probes have a configured frequency",
  ...
  {
    id: uuid(),
    title: "Ensure container probes have a configured timeout",
  ...
  {
    id: uuid(),
    title: "Ensure container probes have a configured minimum success threshold",
  ...
  {
    id: uuid(),
    title: "Ensure container probes have a configured failure threshold",
